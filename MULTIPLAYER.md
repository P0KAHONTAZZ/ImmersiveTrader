...
5. **World NPC/location ownership** — REQUIRED. Verify trader/NPC/location spawning is produced once by the world/server and that clients do not independently create duplicate non-networked trader objects.
