...
- Reaching reputation level 5 grants one fixed, free gift per trader, once per character and world. Grimvald grants 30 Scrap Iron, Mokra Dzika and Encek each grant 30 Silver Ore, Ylva Frost grants 30 Black Metal Scrap, and Tyrron and Grelka each grant 30 Flametal Ore. These six replace their previous utility gifts; players who already received one of the replaced gifts can claim its replacement once. If the inventory is full, free a slot and interact with that trader again; restarting or resetting reputation does not repeat the reward. Biome progression locks apply to the stock and reward.
