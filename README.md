...
- Reaching reputation level 5 grants one fixed, free gift per trader, once per character and world. Grimvald grants 30 Scrap Iron, Mokra Dzika and Encek each grant 30 Silver Ore, Ylva Frost grants 30 Black Metal Scrap, Tyrron grants 5 Molten Cores, and Grelka grants 10 Flametal Ore. Previously claimed versions of those six rewards do not prevent a one-time claim of the latest replacement. If the inventory is full, free a slot and interact with that trader again; restarting or resetting reputation does not repeat the reward. Biome progression locks apply to the stock and reward.
