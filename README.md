...
- Midka additionally sells Minor Healing Mead for 70 coins. Each trader permanently unlocks one new vanilla shop item at reputation levels 2, 3, 4 and 5; each shop purchase provides exactly one item; levels 1-4 do not grant free goods. Metal ore and scrap cost at least 500 coins per unit. Skjold sells one Molten Core for 1,000 coins at level 4.
- Reaching reputation level 5 unlocks one fixed, free gift per trader, once per character and world. The gift is delivered when the player next successfully opens that trader's own shop, including when level five was earned by delivering cargo elsewhere. Grimvald grants 30 Scrap Iron, Mokra Dzika and Encek each grant 30 Silver Ore, Ylva Frost grants 30 Black Metal Scrap, Tyrron grants 5 Molten Cores, and Grelka grants 10 Flametal Ore. Previously claimed versions of those six rewards do not prevent a one-time claim of the latest replacement. If the inventory is full, free a slot and reopen the issuing trader's shop; restarting or resetting reputation does not repeat the reward. Biome progression locks apply to the stock and reward.
- Tyrron and Grelka carry local active Wisplight visuals that clear Mistlands fog near their camp when rendered by a player. Trader locations and protection domes are available. Human trader outfits use the Player visual equipment system; NPC environments remain under development.
