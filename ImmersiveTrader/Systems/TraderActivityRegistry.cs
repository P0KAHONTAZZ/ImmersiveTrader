...
public static class TraderActivityRegistry
{
    public static readonly IReadOnlyList<TraderActivityDefinition> Activities = new List<TraderActivityDefinition>
    {
        ...
        H("midka","midka_3","Troll pod mostem Midki","Troll",15,Skills.SkillType.Crafting,18f,"Pokonaj 15 x Troll."),
        ...
        H("troldad","troldad_3","Troll między pniami","Troll",15,Skills.SkillType.Bows,18f,"Pokonaj 15 x Troll."),
        ...
        H("grimvald","grimvald_3","Troll spod rudnej skały","Troll",15,Skills.SkillType.Crafting,70f,"Pokonaj 15 x Troll."),
        ...
        H("rudy_warg","rudy_3","Troll na szlaku łowców","Troll",15,Skills.SkillType.Sneak,70f,"Pokonaj 15 x Troll."),
        ...
        H("mokra_dzika","dzika_1","Upiór nad czarną wodą","Wraith",15,Skills.SkillType.Farming,140f,"Pokonaj 15 x Wraith."),
        H("mokra_dzika","dzika_2","Elitarny blob w bagnie","BlobElite",30,Skills.SkillType.Cooking,140f,"Pokonaj 30 x Blob Elite."),
        ...
        H("encek","encek_1","Widmo przy żelaznym szlaku","Wraith",15,Skills.SkillType.Fishing,140f,"Pokonaj 15 x Wraith."),
        H("encek","encek_2","Blob w zardzewiałej krypcie","BlobElite",30,Skills.SkillType.Crafting,140f,"Pokonaj 30 x Blob Elite."),
        ...
        H("hrothgar","hrothgar_1","Fenring na lodowej grani","Fenring",18,Skills.SkillType.Pickaxes,230f,"Pokonaj 18 x Fenring."),
        H("hrothgar","hrothgar_2","Smocze pisklę nad przełęczą","Hatchling",30,Skills.SkillType.Bows,230f,"Pokonaj 30 x Hatchling."),
        ...
        H("ylva_frost","ylva_1","Fenring u wrót Ylvy","Fenring",18,Skills.SkillType.Spears,230f,"Pokonaj 18 x Fenring."),
        H("ylva_frost","ylva_2","Pisklę na śnieżnym szczycie","Hatchling",30,Skills.SkillType.Knives,230f,"Pokonaj 30 x Hatchling."),
        ...
        H("bjarki_goldtooth","bjarki_1","Komary śmierci nad złotem","Deathsquito",30,Skills.SkillType.Swords,350f,"Pokonaj 30 x Deathsquito."),
        H("bjarki_goldtooth","bjarki_2","Brutal Fulingów przy targu","GoblinBrute",20,Skills.SkillType.Spears,350f,"Pokonaj 20 x Goblin Brute."),
        H("bjarki_goldtooth","bjarki_3","Lox z równin Bjarkiego","Lox",15,Skills.SkillType.Blocking,450f,"Pokonaj 15 x Lox."),
        ...
        H("ragnar_turnipson","ragnar_1","Komar śmierci w rzepie","Deathsquito",30,Skills.SkillType.Farming,350f,"Pokonaj 30 x Deathsquito."),
        H("ragnar_turnipson","ragnar_2","Fuling Brute przy młynie","GoblinBrute",20,Skills.SkillType.Cooking,350f,"Pokonaj 20 x Goblin Brute."),
        H("ragnar_turnipson","ragnar_3","Lox depczący pola Ragnara","Lox",15,Skills.SkillType.Axes,450f,"Pokonaj 15 x Lox."),
        ...
        H("cmok","cmok_1","Kleszcze w gęstej mgle","Tick",30,Skills.SkillType.BloodMagic,500f,"Pokonaj 30 x Tick."),
        H("cmok","cmok_2","Seeker Brute spod korzeni","SeekerBrute",15,Skills.SkillType.Crossbows,500f,"Pokonaj 15 x Seeker Brute."),
        ...
        H("grelka","grelka_1","Kleszcz przy grzybni Grelki","Tick",30,Skills.SkillType.Swords,500f,"Pokonaj 30 x Tick."),
        H("grelka","grelka_2","Seeker Brute na szlaku magów","SeekerBrute",15,Skills.SkillType.ElementalMagic,500f,"Pokonaj 15 x Seeker Brute."),
        ...
        H("spalony_zenek","zenek_1","Mag spopielonych pod fortem","Charred_Mage",30,Skills.SkillType.Swords,750f,"Pokonaj 30 x Charred Mage."),
        H("spalony_zenek","zenek_2","Walkiria nad obozem Zenka","FallenValkyrie",8,Skills.SkillType.ElementalMagic,750f,"Pokonaj 8 x Fallen Valkyrie."),
        ...
        H("skjold_cinderborn","skjold_1","Mag przy murach Skjolda","Charred_Mage",30,Skills.SkillType.WoodCutting,750f,"Pokonaj 30 x Charred Mage."),
        H("skjold_cinderborn","skjold_2","Walkiria nad fortyfikacją","FallenValkyrie",8,Skills.SkillType.Polearms,750f,"Pokonaj 8 x Fallen Valkyrie."),
